...
The Acadia compiler is actually aware of `Debug.todo` so when it sees it in a `case` like this, it will crash with a bunch of helpful information. It will tell you:
...
This can come up from time to time, but Acadia **will not** let you write code like this:
