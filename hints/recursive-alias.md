...
```elm
type alias Time = Float64

type alias Degree = Float64

type alias Weight = Float64
```

You have not created any *new* types, you just made some alternate names for `Float64`. You can write down things like this and it'll work fine:
...
Okay, so let's say you have some type that may contain itself. In Acadia, a common example of this is a comment that might have subcomments:
